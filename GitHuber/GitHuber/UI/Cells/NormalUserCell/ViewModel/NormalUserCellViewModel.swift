...
final class NormalUserCellViewModel: NormalUserCellViewModelType {
...
extension NormalUserCellViewModel {

    func getCell(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UserCellType? {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "normalUserCell") as? NormalUserCell else {
            return nil
        }
